...
class MusicPlayerStore {
	...
	toggleExpanded(): void {
		...
		// Maintain linkage behavior consistent with original usePlayerState.toggleExpandedUI:
		// When expanded, force unhide and close playlist to avoid state combination anomalies
	...
	toggleHidden(): void {
		...
		// Maintain linkage behavior consistent with original usePlayerState.toggleHiddenUI:
		// When hidden, collapse player and close playlist to prevent expanded UI hanging beside the mini ball
