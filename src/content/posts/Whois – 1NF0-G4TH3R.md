...
- من: support@yourbank.com  
- الموضوع: تحديث معلومات الحساب  
- النص: عشان تحافظ على أمان حسابك، اضغط على الرابط ده لتحديث بياناتك:  
`https://example-bank123.com/login`  

**الدومين الحقيقي اللي هنعمله WHOIS lookup هو:**  
`example-bank123.com`  
مش `yourbank.com` لأنه ممكن يكون مزيف.
...
<button onclick="document.getElementById('whois-result').style.display='block'; this.style.display='none';" style="margin-bottom:10px;">
اضغط هنا لعرض نتيجة WHOIS
</button>

<div id="whois-result" style="display:none; margin-top:10px; padding:15px; background:#1e1e1e; color:#c5c8c6; font-family:monospace; border-radius:5px; overflow-x:auto;">
<pre>
