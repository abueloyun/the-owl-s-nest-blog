...
- **الـ Creation and Expiration Dates :**  متى تم تسجيل الدومين ومتى هيخلص تسجيله  
...
بيانات WHOIS تعتبر كنز من المعلومات خلال مرحلة الاستطلاع (reconnaissance) قبل أي تقييم أمني لأنها يقدرو منها يعرفو:
...
في شركة ما جهاز حماية البريد الإلكتروني كشف رسالة مشبوهة وصلت لشوية موظفين في الشركة. الرسالة بتقول إنها من بنك الشركة وبتطلب من الناس الضغط على رابط لتحديث بيانات الحساب. الراجل المسؤول عن security analyst بدأ التحقيق بعمل WHOIS lookup على الدومين اللي في الرسالة.
...
المعلومات دي مع بعضها بقت Red Flags كبيرة. تاريخ التسجيل الجديد، البيانات المخفية، والاستضافة المشبوهة كلها تشير لإحتمالية وجود حملة تصيد. المحلل بلغ بسرعة قسم الـ IT لحظر الدومين وحذر الموظفين.
...
#### 1. معلومات تسجيل الدومين (Domain Registration)
...
<div style="border:1px solid #3b82f6; background:#0f172a; padding:16px; border-radius:12px; margin-top:30px;">
  <p style="margin:0; color:#e5e7eb; font-size:14px;">
    🔎 <strong>Want to explore WHOIS further?</strong><br>
    <a href="https://www.google.com/search?q=History+of+WHOIS" target="_blank" style="color:#60a5fa; text-decoration:none;">
      Search: "History of WHOIS"
    </a>
  </p>
</div>
</div>
