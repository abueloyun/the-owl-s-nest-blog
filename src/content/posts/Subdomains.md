...
- `dnsenum --enum example.com` 
 هنا بنحدد الـ target domain اللي عايزين نعمله enumeration و `--enum` دي shortcut بتشغل وضع إسمه enum mode يعني بدل ما تشغل features واحدة واحدة بتقول لا شغل كل حاجة 
